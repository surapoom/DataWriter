...
extern int     UseBarsHistory        = 35000;
extern int     UseBarsCollect        = 35000;    
extern int     chartPeriod           = 15; //min
extern bool    CollectClosePrice     = True;
extern bool    CollectOpenPrice      = True;
extern bool    CollectLowerPrice     = True;
extern bool    CollectHigherPrice    = True;
extern bool    CollectRSI            = True;
extern bool    CollectBullPower      = True;
extern bool    CollectBearPower      = True;
extern bool    CollectATR8           = True;
extern bool    CollectMACD           = True;
extern bool    CollectStoch          = True;
...
double usdthb, xaueur, xauusd, xbrusd;
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iClose("USDTHB",chartPeriod,j);
                     xaueur = iClose("XAUEUR",chartPeriod,j);
                     xauusd = iClose("XAUUSD",chartPeriod,j);
                     xbrusd = iClose("XBRUSD",chartPeriod,j);
                     ...
                     data = string(TIME)+","+string(eurusd)+"," + string(gbpusd) + "," +string(audusd)+ "," +string(nzdusd)+ ","
                                            ...
                                            +string(usdthb)+"," + string(xaueur) + "," +string(xauusd)+ "," +string(xbrusd);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iOpen("USDTHB",chartPeriod,j);
                     xaueur = iOpen("XAUEUR",chartPeriod,j);
                     xauusd = iOpen("XAUUSD",chartPeriod,j);
                     xbrusd = iOpen("XBRUSD",chartPeriod,j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iHigh("USDTHB",chartPeriod,j);
                     xaueur = iHigh("XAUEUR",chartPeriod,j);
                     xauusd = iHigh("XAUUSD",chartPeriod,j);
                     xbrusd = iHigh("XBRUSD",chartPeriod,j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iLow("USDTHB",chartPeriod,j);
                     xaueur = iLow("XAUEUR",chartPeriod,j);
                     xauusd = iLow("XAUUSD",chartPeriod,j);
                     xbrusd = iLow("XBRUSD",chartPeriod,j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iRSI("USDTHB",chartPeriod, 8, PRICE_MEDIAN, j);
                     xaueur = iRSI("XAUEUR",chartPeriod, 8, PRICE_MEDIAN, j);
                     xauusd = iRSI("XAUUSD",chartPeriod, 8, PRICE_MEDIAN, j);
                     xbrusd = iRSI("XBRUSD",chartPeriod, 8, PRICE_MEDIAN, j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb  = iBullsPower("USDTHB",chartPeriod, 8, PRICE_MEDIAN, j);
                     xaueur  = iBullsPower("XAUEUR",chartPeriod, 8, PRICE_MEDIAN, j);
                     xauusd  = iBullsPower("XAUUSD",chartPeriod, 8, PRICE_MEDIAN, j);
                     xbrusd  = iBullsPower("XBRUSD",chartPeriod, 8, PRICE_MEDIAN, j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iBearsPower("USDTHB",chartPeriod, 8, PRICE_MEDIAN, j);
                     xaueur = iBearsPower("XAUEUR",chartPeriod, 8, PRICE_MEDIAN, j);
                     xauusd = iBearsPower("XAUUSD",chartPeriod, 8, PRICE_MEDIAN, j);
                     xbrusd = iBearsPower("XBRUSD",chartPeriod, 8, PRICE_MEDIAN, j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iATR("USDTHB",chartPeriod, 8, j);
                     xaueur = iATR("XAUEUR",chartPeriod, 8, j);
                     xauusd = iATR("XAUUSD",chartPeriod, 8, j);
                     xbrusd = iATR("XBRUSD",chartPeriod, 8, j);                     
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iMACD("USDTHB",chartPeriod, 12, 26, 9, 0, 0, j)/100;
                     xaueur = iMACD("XAUEUR",chartPeriod, 12, 26, 9, 0, 0, j);
                     xauusd = iMACD("XAUUSD",chartPeriod, 12, 26, 9, 0, 0, j);
                     xbrusd = iMACD("XBRUSD",chartPeriod, 12, 26, 9, 0, 0, j);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                     ...
                     usdthb = iStochastic("USDTHB",chartPeriod,34, 13, 8, 0, 0, 0, j);
                     xaueur = iStochastic("XAUEUR",chartPeriod,34, 13, 8, 0, 0, 0, j);
                     xauusd = iStochastic("XAUUSD",chartPeriod,34, 13, 8, 0, 0, 0, j);
                     xbrusd = iStochastic("XBRUSD",chartPeriod,34, 13, 8, 0, 0, 0, j);
